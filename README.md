...
## 📍 Processo
O processo de criação durou aproximadamente 3h, com esse projeto, aprendi a utilizar das propria ferramentas do python, como funções e classes, para melhorar a legibilidade e usabilidade do codigo em si.
...
3. Aperte qualquer letra (não consegui mudar isso, perdão)
